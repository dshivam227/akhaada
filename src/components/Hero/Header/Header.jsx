  ...
  return (
    ...
    <div className="header">
      ...
      {menuOpened === false && mobile === true ? (
        ...
        <li ><Link to='header' activeClass='active' spy={true} smooth={true} onClick={() => setMenuOpened(false)}>Home</Link></li>
        ...
        <li><Link to='join' spy={true} smooth={true} onClick={() => setMenuOpened(false)}>Why Us</Link></li>
